...
namespace FileManager
{
    public class Watcher
    {
        ...
        public void Start()
        {
            ...
            {
                Logger.RecordStatusAsync("Warning, watcher need to log option was not found in the config");
                _isNeedToLogWatcher = true;
            }
            if (_isNeedToLogWatcher)
            {
                Logger.RecordStatusAsync("The watcher starts...");
            }
            ...
            if (_isNeedToLogWatcher)
            {
                Logger.RecordStatusAsync("The watcher started...");
            }
            _enabled = true;
            while (_enabled)
            {
        ...
        public void Stop()
        {
            ...
            if (_isNeedToLogWatcher)
            {
                Logger.RecordStatusAsync("The watcher stopped...");
            }
        }
        ...
        private void WatcherRenamed(object sender, RenamedEventArgs e)
        {
            ...
            if (_isNeedToLogWatcher)
            {
                Logger.RecordEntryAsync(fileEvent, filePath);
            }
        }
        ...
        private void WatcherCreated(object sender, FileSystemEventArgs e)
        {
            try
            {
                ...
                {                    
                    _extractor.Extract(e.FullPath, this);                    
                }
            }
            catch (Exception exception)
            {
                Logger.RecordErrorAsync(exception.Message, this);
                Stop();
            }
        }
